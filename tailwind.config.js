...
const pluginsDir = path.join(__dirname, 'tailwind_plugins');
...
const keyframes = tryRequire('./tailwind_plugins/keyframes.js') || {};
const presets = tryRequire('./tailwind_plugins/theme-preset.js') || {};
...
const optionalPlugins = [
  ...
  'table.js',
  'typography.js'
].map(p => tryRequire(`./tailwind_plugins/${p}`)).filter(Boolean);
